...
import com.example.test_auto_browse.io.appium.android.bootstrap.utils.API;
        ...
        try {
            ...
            if (root != null) {
                ...
                if(API.API_18){
                    ...
                    // get real display size, or on the full screen phone, the bottom object rect
                    // is not correct
...
//            writer.close();
    ...
    private static void dumpNodeRec(AccessibilityNodeInfo node, XmlSerializer serializer,int index,
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child != null) {
                Rect childVisibleRect = AccessibilityNodeInfoHelper.getVisibleBoundsInScreen(child, width, height);
                if (child.isVisibleToUser() &&
                        (childVisibleRect.height() > 0 && childVisibleRect.width() > 0)) {
